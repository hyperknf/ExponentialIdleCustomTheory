...
var id = "AbuseLol";
var name = "Abusive Theory";
var description = "Abusive Theory by HyperKNF";
...
var init = () => {
    ...
    // c1
    {
        let getDesc = (level) => "c_1=69" + getC1(level).toString(0);
    ...
    // c2
    {
        let getDesc = (level) => "c_2=420^{" + level + "}";
...
var get2DGraphValue = () => currency.value.sign * (BigNumber.ONE + currency.value.abs()).log10().log10().log10().log10().toNumber();
