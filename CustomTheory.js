...
var getTertiaryEquation = () => `x=${x.toString()}, \\quad\\sqrt[5]{\\ln (k_3x+1)}=${Math.log(x * k3.level) ** 0.2}, \\quad 2^{k_2}-\\pi^{k_3}=${BigNumber.from(2 ** (1 + k2.level) - Math.PI ** (k3.level)).toString()}`
