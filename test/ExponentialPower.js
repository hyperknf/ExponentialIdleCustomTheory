...
var getPublicationMultiplier = tau => 10 * tau.pow(0.125) / (10 + tau.pow(5)).log10()
var getPublicationMultiplierFormula = symbol => `\\frac{10\\sqrt[8]{${symbol}}}{\\log_{10}(10+${symbol}^{5})}`
