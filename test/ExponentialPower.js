...
var initialize = () => {
    ...
    // x
    {
        ...
        x = theory.createUpgrade(103, currency, new ExponentialCost(5e45, Math.log2(1.93)))
    ...
    // y
    {
        ...
        y = theory.createUpgrade(104, currency, new ExponentialCost(5e68, Math.log2(2.03625)))
...
var getPublicationMultiplier = tau => 15 * tau.pow(0.123) / (10 + tau).log10()
var getPublicationMultiplierFormula = symbol => `m=\\frac{15{${symbol}}^{0.123}}{\\log_{10}(10+${symbol})}`
