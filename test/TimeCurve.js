...
var init = () => {
...

    {
        ...
        q1 = theory.createUpgrade(100, currency, new FirstFreeCost(new ExponentialCost(10, Math.log2(1.8))))
...

    {
        ...
        q2 = theory.createUpgrade(200, currency, new ExponentialCost(15, Math.log2(7)))
